...
#define KEY_Change 0x03
#define KEY_HighSpeed 0x04
#define KEY_MiddleSpeed 0x05
#define KEY_LowSpeed 0x06
#define KEY_SETSPEED 0x07
...
void CommendCRC(byte *buf)
{
  uint16_t CRC_data = 0;
  CRC_data = ModRTU_CRC(buf, 6);
  byte CRC_data_HIGHTBYTE = CRC_data / 256;
  byte CRC_data_LOWTBYTE = CRC_data % 256;
  buf[6] = CRC_data_LOWTBYTE;
  buf[7] = CRC_data_HIGHTBYTE;
}
